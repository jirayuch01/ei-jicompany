        ...
        if (req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === '') {
            ...
            user.save(function (err) {
                if (err) {
                    ...
                    var email = {
                        from: 'Ei-Ji Company Staff, eijicompany@zoho.com',
                        to: [user.email],
        ...
        User.findOne({ username: req.body.username }).select('username').exec(function (err, user) {
            if (err) {
                var email = {
                    ...
                    text: 'The following error has been reported in the Ei-Ji Company Application: ' + err,
                    html: 'The following error has been reported in the Ei-Ji Company Application:<br><br>' + err
                };
                client.sendMail(email, function (err, info) {
                    if (err) {
                        console.log(err);
        ...
        User.findOne({ email: req.params.email }).select('email name username').exec(function (err, user) {
            if (err) {
                ...
                if (!user) {
                    ...
                    var email = {
                        from: 'Localhost Staff, eijicompany@zoho.com',
                        to: user.email,
                        subject: 'Localhost Username Request',
                        text: 'Hello, ' + user.name + ', You recently requested your username. <br>Your username is: ' + user.username,
                        html: 'Hello,<strong> ' + user.name + '</strong>,<br><br>You recently requested your username. <br>Your username is: ' + user.username
                    };
                    client.sendMail(email, function (err, info) {
                        if (err) {
                            console.log(err);
                    ...
                    user.save(function (err) {
                        if (err) {
                            ...
                            var email = {
                                ...
                                text: 'Hello, ' + user.name + ', You recently request a password reset link. <br>Please click on the link below to reset your password:<br><br><a href="http://localhost:8080/reset/' + user.resettoken,
                                html: 'Hello,<strong> ' + user.name + '</strong>,<br><br>You recently request a password reset link. <br>Please click on the link below to reset your password:<br><br><a href="http://localhost:8080/reset/' + user.resettoken + '">http://localhost:8080/reset/</a>'
                            };
                            client.sendMail(email, function (err, info) {
                                if (err) {
                                    console.log(err);
